  ...
  return (
    <EditorSide title="MARKDOWN">
      <textarea
        ...
        value={value}
        id="textarea-editor"
        className="textarea-editor w-full h-full min-h-[79.9vh] pr-3 bg-transparent font-Sec dark:text-gray-200 text-black-0 text-sm font-light resize-none md:border-r-2 leading-6 tracking-wider outline-none dark:border-r-gray-200 border-r-white-200/100 border-solid  " 
      ></textarea>
    </EditorSide>
  );
};
