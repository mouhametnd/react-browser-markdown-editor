import type { HasClassName } from '../../types/types';

const DocumentSvg = ({ className }: HasClassName) => {
  return (
    <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" className={className || ''}>
      <path
